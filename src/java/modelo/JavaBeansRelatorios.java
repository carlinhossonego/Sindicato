...
public class JavaBeansRelatorios {
    ...
    //CONSTRUTOR
    public JavaBeansRelatorios() {
        super();
    }

    public JavaBeansRelatorios(String ID_cortes, String Associado_ID, String Associado_Id_Dependente, String Data_Corte, String ID_Empresa, String Pago) {
        super();
    ...
    public JavaBeansRelatorios(String ID_cortes, String Associado_ID, String Associado_Id_Dependente, String Data_Corte, String ID_Empresa, String Pago, String Nomeempresa) {
        super();
        this.ID_cortes = ID_cortes;
        this.Associado_ID = Associado_ID;
        this.Associado_Id_Dependente = Associado_Id_Dependente;
